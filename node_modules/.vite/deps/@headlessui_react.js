...
function F(n13, r20 = {}, e8, a25, s15) {
  ...
  if (r20) {
    let d14 = false, p6 = [];
    for (let [c19, T12] of Object.entries(r20))
...
function P2(...n13) {
  ...
  for (let s15 of n13)
    for (let t12 in s15)
      t12.startsWith("on") && typeof s15[t12] == "function" ? ((a25 = e8[t12]) != null || (e8[t12] = []), e8[t12].push(s15[t12])) : r20[t12] = s15[t12];
...
function e2(i19 = {}, s15 = null, t12 = []) {
  for (let [r20, n13] of Object.entries(i19))
    o7(t12, f3(s15, r20), n13);
  return t12;
}
function f3(i19, s15) {
...
function o7(i19, s15, t12) {
  if (Array.isArray(t12))
    for (let [r20, n13] of t12.entries())
      o7(i19, f3(s15, r20.toString()), n13);
  else
...
function pe(T12, h11) {
  let C10 = (0, import_react50.useId)(), k5 = u4(), x11 = a3(), { id: g8 = k5 || `headlessui-checkbox-${C10}`, disabled: e8 = x11 || false, autoFocus: s15 = false, checked: E15, defaultChecked: v5, onChange: P7, name: d14, value: D8, form: R9, indeterminate: n13 = false, tabIndex: A8 = 0, ...F9 } = T12, r20 = l2(v5), [a25, t12] = T(E15, P7, r20 != null ? r20 : false), K4 = I(), _8 = U2(), H14 = p(), [p6, c19] = (0, import_react56.useState)(false), u19 = o5(() => {
    ...
    if (r20 !== void 0)
      return t12 == null ? void 0 : t12(r20);
  }, [t12, r20]), W3 = L();
...
function m5(t12) {
  ...
  if (r20 === 1 ? u9.delete(t12) : u9.set(t12, r20 - 1), r20 !== 1)
    return;
  let e8 = f9.get(t12);
...
function R3(p6, f22, C10) {
  let u19 = x2(p6, "outside-click"), m11 = s3(C10), s15 = (0, import_react66.useCallback)(function(e8, n13) {
    ...
    for (let l17 of h11)
      if (l17 !== null && (l17.contains(r20) || e8.composed && e8.composedPath().includes(l17)))
        return;
...
function e6(t12, u19) {
  return (0, import_react70.useMemo)(() => {
    ...
    if (typeof r20 == "string" && r20.toLowerCase() === "button" || (u19 == null ? void 0 : u19.tagName) === "BUTTON" && !u19.hasAttribute("type"))
      return "button";
  }, [t12.type, t12.as, u19]);
}
...
var m9 = class {
  ...
  send(e8) {
    ...
    for (let r20 of a12(this, s8).get(e8.type))
      r20(a12(this, i12), e8);
  }
};
...
function u13(t12, e8) {
  do {
    ...
    if (r20.done && n13.done)
      return true;
    if (r20.done || n13.done || !Object.is(r20.value, n13.value))
      return false;
  } while (true);
}
function S5(t12) {
...
t7(() => {
  function e8(t12) {
    if (!(t12.target instanceof HTMLElement) || t12.target === document.body || r11[0] === t12.target)
      return;
    let n13 = t12.target;
...
var F4 = { [1](t12) {
  ...
  var r20, u19, a25, p6;
  if ((r20 = t12.dataRef.current) != null && r20.disabled || t12.optionsElement && !((u19 = t12.dataRef.current) != null && u19.optionsPropsRef.current.static) && t12.comboboxState === 1)
    return t12;
  if (t12.virtual) {
  ...
  var r20, u19, a25, p6;
  if ((r20 = t12.dataRef.current) != null && r20.virtual)
...
var O4 = class _O extends m9 {
  constructor() {
    ...
    c14(this, "selectors", { activeDescendantId: (e8) => {
      ...
      if (n13 !== null)
        return e8.virtual ? (r20 = e8.options.find((u19) => !u19.dataRef.current.disabled && e8.dataRef.current.compare(u19.dataRef.current.value, e8.virtual.options[n13]))) == null ? void 0 : r20.id : (o21 = e8.options[n13]) == null ? void 0 : o21.id;
  ...
  let r20 = n9(o21), u19 = o5(() => {
    ...
    if (n13 != null && n13.current)
      for (let e8 of n13.current)
        t12.push(e8);
    for (let e8 of (i19 = r20 == null ? void 0 : r20.querySelectorAll("html > *, body > *")) != null ? i19 : [])
...
function Ae(e8, t12) {
  ...
  let B5 = l10();
  n(() => {
    if (f22 && B5 && m11 === "visible" && r20.current === null)
...
function Ee2(e8, t12) {
  let l17 = (0, import_react50.useId)(), { id: p6 = `headlessui-disclosure-button-${l17}`, disabled: i19 = false, autoFocus: c19 = false, ...n13 } = e8, [o21, r20] = M8("Disclosure.Button"), m11 = fe2(), s15 = m11 === null ? false : m11 === o21.panelId, E15 = (0, import_react96.useRef)(null), f22 = y(E15, t12, o5((u19) => {
    if (!s15)
      return r20({ type: 4, element: u19 });
  }));
  (0, import_react96.useEffect)(() => {
    if (!s15)
      return r20({ type: 2, buttonId: p6 }), () => {
...
var M9 = { [1](e8) {
  ...
  if (i19.focus === c10.Specific)
    return { ...t12, activeOptionIndex: e8.options.findIndex((r20) => r20.id === i19.id) };
...
var F7 = { [1](e8) {
  ...
  for (let [u19, m11] of t12.entries())
    if (l17.has(m11.id) && (r20.push(u19), l17.delete(m11.id), l17.size === 0))
      break;
  if (r20.length > 0) {
    t12 = t12.slice();
    for (let u19 of r20.reverse())
      t12.splice(u19, 1);
  }
...
function Et3(t12, l17) {
  ...
  let x11 = o5((e8) => {
    ...
    switch (e8.key) {
      case o9.Escape:
        if (o21.popoverState !== 0 || !r20.current || B5 != null && B5.activeElement && !r20.current.contains(B5.activeElement))
          return;
  ...
  (0, import_react108.useEffect)(() => {
    ...
    if (o21.__demoMode || !m11 || o21.popoverState !== 0 || !r20.current)
      return;
...
function gt2(t12, l17) {
  let P7 = (0, import_react108.useRef)(null), C10 = y(P7, l17), [m11, A8] = (0, import_react108.useState)([]), s15 = o5((d14) => {
    ...
    for (let r20 of m11)
      r20.buttonId.current !== d14 && r20.close();
...
function xe2(n13, o21) {
  ...
  let s15 = (0, import_react50.useId)(), h11 = u4(), b11 = a3(), { id: T12 = h11 || `headlessui-switch-${s15}`, disabled: t12 = b11 || false, checked: p6, defaultChecked: y8, onChange: S10, name: c19, value: u19, form: d14, autoFocus: m11 = false, ...F9 } = n13, _8 = (0, import_react111.useContext)(E13), [H14, k5] = (0, import_react111.useState)(null), M11 = (0, import_react111.useRef)(null), U7 = y(M11, o21, _8 === null ? null : _8.setSwitch, k5), l17 = l2(y8), [a25, r20] = T(p6, S10, l17 != null ? l17 : false), I7 = p(), [P7, D8] = (0, import_react111.useState)(false), g8 = o5(() => {
    ...
    if (l17 !== void 0)
      return r20 == null ? void 0 : r20(l17);
  }, [r20, l17]), z3 = L();
