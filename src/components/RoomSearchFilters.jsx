  ...
  return (
    <section className="bg-white py-6">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex flex-wrap gap-2 items-center text-sm text-gray-700 mt-4">
          <span className="inline-block text-[11px] font-medium text-green-700 border border-green-300 px-2 py-1 rounded-full shadow-sm">
            {t("actions.freeCancellation", "Free cancellation")}
          </span>
          <span className="inline-block text-[11px] font-medium text-[#A58E63] border border-[#A58E63] px-2 py-1 rounded-full shadow-sm">
            {t("actions.noCreditCard", "No credit card required")}
          </span>
        </div>
      </div>
    </section>
