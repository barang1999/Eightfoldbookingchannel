...
const ModifyRoomCard = ({ room, propertyId, breakfastIncluded, onAddRoom, loadingRate }) => {
  ...
  const perNight = room.perNight ?? displayPrice;
  const totalStayPrice = displayPrice; // displayPrice already represents the full total
              ...
              onClick={() => {
                if (!isSoldOut && !atLimit) {
                  ...
                  const selectedRoomData = {
                    ...
                    startDate: startDate,
                    endDate: endDate,
                    breakfastIncluded: room.breakfastIncluded === true || room.breakfastIncluded === "true",
                    price: displayPrice,
                    perNight: displayPrice / nights,
                    nights,
                    vat: displayPrice * 0.1,
                  ...
                  for (let i = 0; i < quantity; i++) {
                    ...
                    const payload = { ...selectedRoomData, instanceId };
